...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BcI2o8lP.js");
...
const manifest = {
  "208c039ae44223356546a00df7aad7c56f7d8a718c391fb5797206d2d14e61fe": {
    functionName: "getOrderFromServer_createServerFn_handler",
    importer: () => import("./track._id-C3YnQKS-.js")
  },
  "9002f3a6ed88f5cd34fea0f99fdc18841d17219c7404a8be43b7e5913627d422": {
    functionName: "getProductFromServer_createServerFn_handler",
    importer: () => import("./product._id-DDiT0GdE.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-JlluT2Qz.js").then((n2) => n2.f),
    import("./start-RW7d5fnp.js"),
