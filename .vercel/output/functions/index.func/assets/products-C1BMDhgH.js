import { t as teak } from "./product-teakframe-DKClPXyG.js";
const coaster = "/assets/product-coaster-BsE_aJvH.jpg";
const hex = "/assets/product-hex-CmLuR9QN.jpg";
const hoop = "/assets/product-hoop-aD4MYgbq.jpg";
const products = [
  {
    id: "teak-frame",
    ...
    image: teak,
    badge: "Bestseller",
    description: "A soulfully handcrafted vessel for your most cherished memories. Reclaimed teak meets the ethereal transparency of premium epoxy resin — each pour a unique dance of light and shadow."
  },
  {
    id: "ethereal-coaster",
...
const pricingVariants = [
  { id: "5x5-frame", name: "5×5 Frame", basePrice: 2e3 },
